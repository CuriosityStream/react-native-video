package com.brentvatne.exoplayer.download.models
...
data class VideoRequestModel(val id: String?, val url: String?, val licenseUrl: String?, val scheme: String?, val title: String?, val drmLicenseRequestHeaders: HashMap<String, Any>?){
  fun toMediaItem(): MediaItem?{
    ...
    mediaBuilder.setUri(this.url)
      .setMediaMetadata(MediaMetadata.Builder().setTitle(this.url).build())
